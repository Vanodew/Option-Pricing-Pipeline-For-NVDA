> **Archived 2026-09-13.** This is the original `README.md`, preserved unedited:
> the v0 option-pricing write-up plus the full 13-phase research plan (Phases
> 0–12). It was the repo's front page from the start until the study was
> finished and written up.
>
> It is kept for reference and is **not a current plan**. Phases 0–4, 7 and 8
> were built; 5 and 6 became the GBT strand; 9–12 were cut on 2026-08-24 when
> the project was deliberately scoped down to a single answerable question. See
> `README.md` for what was actually built and found, and `CLAUDE.md` for the
> scope decisions and what remains parked.
>
> Nothing below has been edited. Awaiting review — decide what, if anything,
> should be folded back into `README.md`.
